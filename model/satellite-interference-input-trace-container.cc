...
SatInterferenceInputTraceContainer::AddNode (key_t key)
{
  ...
  filename << m_currentWorkingDirectory << "/data/satellite/interference_trace/input/id_" << SatHelper::m_satMacIdMacMapper->GetId (key.first) << "_channelType_" << SatEnums::GetChannelTypeName (key.second);
