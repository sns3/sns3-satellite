...
SatGeoUserMac::SatGeoUserMac(uint32_t satId,
                             uint32_t beamId,
...
void
SatGeoUserMac::ReceiveSignalingPacket(Ptr<Packet> packet)
{
...
Address
SatGeoUserMac::GetRxUtAddress(Ptr<Packet> packet)
{
    NS_LOG_FUNCTION(this << packet);
