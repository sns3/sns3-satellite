                              ...
                              std::string packetInfo)
{
    ...
    oss << now.GetSeconds() << " " << SatEnums::GetPacketEventName(packetEvent) << " "
        << SatEnums::GetNodeTypeName(nodeType) << " " << nodeId << " " << macAddress << " "
        << SatEnums::GetLogLevelName(logLevel) << " " << SatEnums::GetLinkDirName(linkDir) << " "
        << packetInfo;
