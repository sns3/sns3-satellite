...
{
public:
  class Event : public SimpleRefCount<SatPerPacketInterference::Event>
  {
public:
...
private:
  ...
  Ptr<SatPerPacketInterference::Event> Add (uint32_t size, WifiMode payloadMode,
                                      enum WifiPreamble preamble,
                                      Time duration, double rxPower);

  struct SatPerPacketInterference::SnrPer CalculateSnrPer (Ptr<SatPerPacketInterference::Event> event);
  void NotifyRxStart ();
  void NotifyRxEnd ();
