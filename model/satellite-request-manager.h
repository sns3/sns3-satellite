...
class SatRequestManager : public Object
{
  public:
     ...
     */
    void SendHandoverRecommendation(uint32_t beamId, uint32_t satId);
  ...
  private:
    ...
    /**
     * Additional VBDC to add to take into account E2E header in regenerative LINK or NETWORK, and
     * in worst case
     */
