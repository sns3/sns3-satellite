...
class SatMarkovContainer : public SatBaseFading
{
  public:
     ...
     * parameter in DoGetFading method to be able to get the fading from the correct fading file.
     * Note, that the Address parameter is not utilized in SatMarkovContainer::DoGetFading () at
     * all. \param macAddress MAC address \param channeltype channel type \return fading value
     */
