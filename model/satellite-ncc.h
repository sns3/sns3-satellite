...
class SatNcc : public Object
{
  public:
     ...
     */
    void SetRandomAccessAverageNormalizedOfferedLoadThreshold(uint8_t allocationChannelId,
                                                              double threshold);
     ...
     */
    void SetRandomAccessLowLoadBackoffProbability(uint8_t allocationChannelId,
     ...
     */
    void SetRandomAccessHighLoadBackoffProbability(uint8_t allocationChannelId,
     ...
     * backoff time
     */
    void SetRandomAccessLowLoadBackoffTime(uint8_t allocationChannelId,
     ...
     * backoff time
     */
    void SetRandomAccessHighLoadBackoffTime(uint8_t allocationChannelId,
