 ...
 *
 *        SatFwdLinkScheduler communicated through callback functions to request scheduling objects
 * and notifying TX opportunities.
 *
...
class SatFwdLinkScheduler : public Object
{
  ...
  protected:
    ...
    /**
     * The interval for periodic scheduling timer. Timer is evaluated by scheduling calls to
