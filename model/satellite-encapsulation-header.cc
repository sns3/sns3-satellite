...
NS_LOG_COMPONENT_DEFINE ("SatEncapsulationHeader");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (SatEncapsulationHeader);

SatEncapsulationHeader::SatEncapsulationHeader ()
  : m_headerLength (0),
    m_framingInfo (0xff),
...
void
SatEncapsulationHeader::SetFramingInfo (uint8_t framingInfo)
{
  m_framingInfo = framingInfo & 0x03;
}

void
SatEncapsulationHeader::SetSequenceNumber (SequenceNumber10 sequenceNumber)
{
  m_sequenceNumber = sequenceNumber;
}

uint8_t
SatEncapsulationHeader::GetFramingInfo () const
{
  return m_framingInfo;
}

SequenceNumber10
SatEncapsulationHeader::GetSequenceNumber () const
{
...
void
SatEncapsulationHeader::PushExtensionBit (uint8_t extensionBit)
{
...
void
SatEncapsulationHeader::PushLengthIndicator (uint16_t lengthIndicator)
{
...
uint8_t
SatEncapsulationHeader::PopExtensionBit (void)
{
...
uint16_t
SatEncapsulationHeader::PopLengthIndicator (void)
{
...
TypeId
SatEncapsulationHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::SatEncapsulationHeader")
    .SetParent<Header> ()
    .AddConstructor<SatEncapsulationHeader> ()
  ;
  return tid;
}

TypeId
SatEncapsulationHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

void SatEncapsulationHeader::Print (std::ostream &os)  const
{
...
uint32_t SatEncapsulationHeader::GetSerializedSize (void) const
{
  return m_headerLength;
}

void SatEncapsulationHeader::Serialize (Buffer::Iterator start) const
{
...
uint32_t SatEncapsulationHeader::Deserialize (Buffer::Iterator start)
{
  Buffer::Iterator i = start;
  uint8_t byte_1;
  uint8_t byte_2;
