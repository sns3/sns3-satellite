...
static const double g_LooParameters[SatLooConf::DEFAULT_ELEVATION_COUNT][SatLooConf::DEFAULT_STATE_COUNT][SatLooConf::DEFAULT_LOO_PARAMETER_COUNT] =
    {
     /* Elevation 40 */
     {{-0.1,0.37,-22.0,4,4,0.15,100},
      {-1.0,0.5,-22.0,4,4,0.15,100},
      {-2.25,0.13,-21.2,4,4,0.15,100}},

     /* Elevation 60 */
     {{0.0,0.12,-24.9,4,4,0.15,100},
      {-0.7,0.12,-26.1,4,4,0.15,100},
      {-1.4,0.25,-23.1,4,4,0.15,100}},

     /* Elevation 70 */
     {{-0.1,0.25,-22.5,4,4,0.15,100},
      {-0.5,0.28,-24.5,4,4,0.15,100},
      {-0.75,0.37,-23.24,4,4,0.15,100}},

     /* Elevation 80 */
     {{0.1,0.16,-22.4,4,4,0.15,100},
      {-0.4,0.15,-23.5,4,4,0.15,100},
      {-0.72,0.27,-22.0,4,4,0.15,100}}
    };
