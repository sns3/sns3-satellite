...
class SatLowerLayerServiceConf : public Object
{
  ...
  private:
    ...
    static std::string GetNumberAsString(T number)
    {
        ...
        ss << (double)number; // add number to the stream as double always to show number correctly
                              // in outputs
 ...
 *
 *  - SetDaServ0ConstantAssignmentProvided, see
 * @SatLowerLayerServiceEntry::SetConstantAssignmentProvided
 *  - GetDaServ0ConstantAssignmentProvided, see
 * @SatLowerLayerServiceEntry::GetConstantAssignmentProvided
 ...
 *  - SetDaServ0ConstantServiceRateStream, see
 * @SatLowerLayerServiceEntry::SetonstantServiceRateStream
 *  - GetDaServ0ConstantServiceRateStream, see
 * @SatLowerLayerServiceEntry::GetonstantServiceRateStream
 *  - SetDaServ0MaximumServiceRateInKbps, see
 * @SatLowerLayerServiceEntry::SetMaximumServiceRateInKbps
 *  - GetDaServ0MaximumServiceRateInKbps, see
 * @SatLowerLayerServiceEntry::GetMaximumServiceRateInKbps
 *  - SetDaServ0MinimumServiceRateInKbps, see
 * @SatLowerLayerServiceEntry::SetMinimumServiceRateInKbps
 *  - GetDaServ0MinimumServiceRateInKbps, see
 * @SatLowerLayerServiceEntry::GetMinimumServiceRateInKbps
 *  - SetDaServ0MaximumBacklogSizeInBytes, see
 * @SatLowerLayerServiceEntry::SetMaximumBacklogSizeInKbytes
 ...
 *  Methods defined e.g. when index is 0.
 *
 *  - SetRaServ0MaximumUniquePayloadPerBlock, see
 * @SatLowerLayerServiceRaEntry::SetMaximumUniquePayloadPerBlock
 *  - GetRaServ0MaximumUniquePayloadPerBlock, see
 * @SatLowerLayerServiceRaEntry::GetMaximumUniquePayloadPerBlock
 *  - SetRaServ0MaximumConsecutiveBlockAccessed, see
 * @SatLowerLayerServiceRaEntry::SetMaximumConsecutiveBlockAccessed
 *  - GetRaServ0MaximumConsecutiveBlockAccessed, see
 * @SatLowerLayerServiceRaEntry::GetMaximumConsecutiveBlockAccessed
 ...
 *  - SetRaServ0BackOffTimeInMilliSeconds, see
 * @SatLowerLayerServiceRaEntry::SetBackOffTimeInMilliSeconds
 *  - GetRaServ0BackOffTimeInMilliSeconds, see
 * @SatLowerLayerServiceRaEntry::GetBackOffTimeInMilliSeconds
 *  - SetRaServ0HighLoadBackOffTimeInMilliSeconds, see
 * @SatLowerLayerServiceRaEntry::SetHighLoadBackOffTimeInMilliSeconds
 *  - GetRaServ0HighLoadBackOffTimeInMilliSeconds, see
 * @SatLowerLayerServiceRaEntry::GetHighLoadBackOffTimeInMilliSeconds
 ...
 *  - SetRaServ0HighLoadBackOffProbability, see
 * @SatLowerLayerServiceRaEntry::SetHighLoadBackOffProbability
 *  - GetRaServ0HighLoadBackOffProbability, see
 * @SatLowerLayerServiceRaEntry::GetHighLoadBackOffProbability
 ...
 *  - SetRaServ0AverageNormalizedOfferedLoadThreshold, see
 * @SatLowerLayerServiceRaEntry::SetAverageNormalizedOfferedLoadThreshold
 *  - GetRaServ0AverageNormalizedOfferedLoadThreshold, see
 * @SatLowerLayerServiceRaEntry::GetAverageNormalizedOfferedLoadThreshold
