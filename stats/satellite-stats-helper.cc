    ...
    static TypeId tid =
        TypeId("ns3::SatStatsHelper")
            ...
            .AddAttribute("IdentifierType",
                          ...
                          MakeEnumAccessor<SatStatsHelper::IdentifierType_t>(&SatStatsHelper::SetIdentifierType,
            ...
            .AddAttribute(
                ...
                MakeEnumAccessor<SatStatsHelper::OutputType_t>(&SatStatsHelper::SetOutputType, &SatStatsHelper::GetOutputType),
