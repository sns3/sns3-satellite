...
{
  static TypeId tid = TypeId ("ns3::SatStatsCarrierIdHelper")
    ...
    case SatStatsHelper::OUTPUT_SCALAR_FILE:
      {
        ...
        m_aggregator = CreateAggregator ("ns3::MultiFileAggregator",
                                         ...
                                         "GeneralHeading", StringValue (GetIdentifierHeading ("carrier_id")));
    ...
    case SatStatsHelper::OUTPUT_SCATTER_FILE:
      {
        ...
        m_aggregator = CreateAggregator ("ns3::MultiFileAggregator",
                                         "OutputFileName", StringValue (GetOutputFileName ()),
                                         "GeneralHeading", StringValue (GetTimeHeading ("carrier_id")));
        ...
        m_terminalCollectors.SetAttribute ("IntervalLength",
      ...
      for (NetDeviceContainer::Iterator itDev = devs.Begin ();
           itDev != devs.End (); ++itDev)
        {
          ...
          for (ObjectVectorValue::Iterator itCarrier = carriers.Begin ();
            ...
            {
              Ptr<SatPhyRxCarrierPerSlot> c = DynamicCast<SatPhyRxCarrierPerSlot> (itCarrier->second);
              if (!c)
                {
                  continue;
                }
