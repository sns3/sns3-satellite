 ...
 * - [Global, PerGw, PerBeam, PerGroup, PerUt, PerSat] [Fwd, Rtn] [Feeder, User] [Dev, Mac, Phy]
 * LinkDelay
 ...
 * - [Global, PerGw, PerBeam, PerGroup, PerUt, PerSat] [Feeder, User] [FwdDa, RtnDa, SlottedAloha,
 * Crdsa, Essa] PacketError
 * - [Global, PerGw, PerBeam, PerGroup, PerUt, PerSat] [Feeder, User] [SlottedAloha, Crdsa, Essa]
 * PacketCollision
 ...
 * Packets
 * - AddAverage [Beam, Group, Ut, Sat] [RtnFeeder, FwdUser] Queue [Bytes, Packets] * - Add [Global,
 * PerGw, PerBeam, PerGroup, PerUt, PerSat] [Fwd, Rtn] SignallingLoad
...
// Random Access Feeder Slotted ALOHA packet collision rate statistics.
SAT_STATS_GLOBAL_METHOD_DEFINITION(FeederSlottedAlohaPacketCollision,
                                   "feeder-slotted-aloha-collision")
SAT_STATS_PER_GW_METHOD_DEFINITION(FeederSlottedAlohaPacketCollision,
                                   "feeder-slotted-aloha-collision")
SAT_STATS_PER_BEAM_METHOD_DEFINITION(FeederSlottedAlohaPacketCollision,
                                     "feeder-slotted-aloha-collision")
SAT_STATS_PER_GROUP_METHOD_DEFINITION(FeederSlottedAlohaPacketCollision,
                                      "feeder-slotted-aloha-collision")
SAT_STATS_PER_UT_METHOD_DEFINITION(FeederSlottedAlohaPacketCollision,
                                   "feeder-slotted-aloha-collision")
SAT_STATS_PER_SAT_METHOD_DEFINITION(FeederSlottedAlohaPacketCollision,
                                    "feeder-slotted-aloha-collision")
...
SAT_STATS_PER_BEAM_METHOD_DEFINITION(UserSlottedAlohaPacketCollision,
                                     "user-slotted-aloha-collision")
SAT_STATS_PER_GROUP_METHOD_DEFINITION(UserSlottedAlohaPacketCollision,
                                      "user-slotted-aloha-collision")
