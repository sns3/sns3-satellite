...
{
    static TypeId tid = TypeId("ns3::SatStatsLinkSinrHelper").SetParent<SatStatsHelper>();
    return tid;
}

void
SatStatsLinkSinrHelper::SetAveragingMode(bool averagingMode)
{
...
void
SatStatsLinkSinrHelper::SinrCallback(double sinrDb, const Address& from)
{
    ...
    else if (Mac48Address::ConvertFrom(from).IsBroadcast())
    {
        ...
        {
            PassSampleToCollector(sinrDb, item.second);
        }
    }
    else
    {
        ...
        {
            PassSampleToCollector(sinrDb, it->second);
        }
        else
        {
            NS_LOG_WARN(this << " discarding a packet with a sinr of " << sinrDb << "dB"
...
void
SatStatsLinkSinrHelper::SaveAddressAndIdentifier(Ptr<Node> utNode)
{
...
bool
SatStatsLinkSinrHelper::ConnectProbeToCollector(Ptr<Probe> probe, uint32_t identifier)
{
...
void
SatStatsLinkSinrHelper::PassSampleToCollector(double sinrDb, uint32_t identifier)
{
    // NS_LOG_FUNCTION (this << sinrDb << identifier);
...
{
    static TypeId tid =
        TypeId("ns3::SatStatsFwdFeederLinkSinrHelper").SetParent<SatStatsLinkSinrHelper>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("ns3::SatStatsFwdUserLinkSinrHelper").SetParent<SatStatsLinkSinrHelper>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("ns3::SatStatsRtnFeederLinkSinrHelper").SetParent<SatStatsLinkSinrHelper>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("ns3::SatStatsRtnUserLinkSinrHelper").SetParent<SatStatsLinkSinrHelper>();
    return tid;
}
