...
{
  static TypeId tid = TypeId ("ns3::SatStatsLinkJitterHelper")
    ...
    case SatStatsHelper::OUTPUT_SCALAR_FILE:
      {
        ...
        m_aggregator = CreateAggregator ("ns3::MultiFileAggregator",
                                         ...
                                         "GeneralHeading", StringValue (GetIdentifierHeading ("jitter_sec")));
    ...
    case SatStatsHelper::OUTPUT_SCATTER_FILE:
      {
        ...
        m_aggregator = CreateAggregator ("ns3::MultiFileAggregator",
                                         "OutputFileName", StringValue (GetOutputFileName ()),
                                         "GeneralHeading", StringValue (GetTimeHeading ("jitter_sec")));
...
void
SatStatsLinkJitterHelper::SaveAddressAndIdentifier (Ptr<Node> utNode)
{
...
bool
SatStatsLinkJitterHelper::ConnectProbeToCollector (Ptr<Probe> probe,
                                              uint32_t identifier)
{
...
SatStatsFwdFeederMacLinkJitterHelper::SatStatsFwdFeederMacLinkJitterHelper (Ptr<const SatHelper> satHelper)
  : SatStatsLinkJitterHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
}
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdFeederMacLinkJitterHelper")
    .SetParent<SatStatsLinkJitterHelper> ()
  ;
  return tid;
}
...
SatStatsFwdUserMacLinkJitterHelper::SatStatsFwdUserMacLinkJitterHelper (Ptr<const SatHelper> satHelper)
  : SatStatsLinkJitterHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
}
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdUserMacLinkJitterHelper")
    .SetParent<SatStatsLinkJitterHelper> ()
  ;
  return tid;
}
...
SatStatsFwdFeederPhyLinkJitterHelper::SatStatsFwdFeederPhyLinkJitterHelper (Ptr<const SatHelper> satHelper)
  : SatStatsLinkJitterHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdFeederPhyLinkJitterHelper")
    .SetParent<SatStatsLinkJitterHelper> ()
  ;
  return tid;
}
...
SatStatsFwdUserPhyLinkJitterHelper::SatStatsFwdUserPhyLinkJitterHelper (Ptr<const SatHelper> satHelper)
  : SatStatsLinkJitterHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdUserPhyLinkJitterHelper")
    .SetParent<SatStatsLinkJitterHelper> ()
  ;
  return tid;
}
...
SatStatsRtnFeederMacLinkJitterHelper::SatStatsRtnFeederMacLinkJitterHelper (Ptr<const SatHelper> satHelper)
  : SatStatsLinkJitterHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
}
...
{
  static TypeId tid = TypeId ("ns3::SatStatsRtnFeederMacLinkJitterHelper")
    .SetParent<SatStatsLinkJitterHelper> ()
  ;
  return tid;
}
...
SatStatsRtnUserMacLinkJitterHelper::SatStatsRtnUserMacLinkJitterHelper (Ptr<const SatHelper> satHelper)
  : SatStatsLinkJitterHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
}
...
{
  static TypeId tid = TypeId ("ns3::SatStatsRtnUserMacLinkJitterHelper")
    .SetParent<SatStatsLinkJitterHelper> ()
  ;
  return tid;
}
...
SatStatsRtnFeederPhyLinkJitterHelper::SatStatsRtnFeederPhyLinkJitterHelper (Ptr<const SatHelper> satHelper)
  : SatStatsLinkJitterHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
...
{
  static TypeId tid = TypeId ("ns3::SatStatsRtnFeederPhyLinkJitterHelper")
    .SetParent<SatStatsLinkJitterHelper> ()
  ;
  return tid;
}
...
SatStatsRtnUserPhyLinkJitterHelper::SatStatsRtnUserPhyLinkJitterHelper (Ptr<const SatHelper> satHelper)
  : SatStatsLinkJitterHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
...
{
  static TypeId tid = TypeId ("ns3::SatStatsRtnUserPhyLinkJitterHelper")
    .SetParent<SatStatsLinkJitterHelper> ()
  ;
  return tid;
}
