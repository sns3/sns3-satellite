...
{
    static TypeId tid =
        TypeId("ns3::SatStatsLinkModcodHelper")
...
SatStatsLinkModcodHelper::DoInstall()
{
    ...
    case SatStatsHelper::OUTPUT_SCALAR_FILE: {
        ...
        m_aggregator = CreateAggregator("ns3::MultiFileAggregator",
                                        ...
                                        BooleanValue(true),
                                        "GeneralHeading",
                                        StringValue(GetIdentifierHeading("modcod_id")));
    ...
    case SatStatsHelper::OUTPUT_SCATTER_FILE: {
        ...
        m_aggregator = CreateAggregator("ns3::MultiFileAggregator",
                                        ...
                                        StringValue(GetOutputFileName()),
                                        "GeneralHeading",
                                        StringValue(GetTimeHeading("modcod_id")));
    ...
    case SatStatsHelper::OUTPUT_CDF_FILE: {
        if (m_averagingMode)
        {
            ...
            m_aggregator = CreateAggregator("ns3::MultiFileAggregator",
                                            ...
                                            BooleanValue(false),
                                            "GeneralHeading",
                                            StringValue(GetDistributionHeading("modcod_id")));
    ...
    case SatStatsHelper::OUTPUT_SCATTER_PLOT: {
        ...
        // plot->SetTitle ("");
        plotAggregator->SetLegend("Time (in seconds)", "MODCOD ID");
    ...
    case SatStatsHelper::OUTPUT_CDF_PLOT: {
        if (m_averagingMode)
        {
            ...
            NS_ASSERT(plotAggregator != nullptr);
            // plot->SetTitle ("");
            plotAggregator->SetLegend("MODCOD ID", "Frequency");
            plotAggregator->Set2dDatasetDefaultStyle(Gnuplot2dDataset::LINES);
...
bool
SatStatsLinkModcodHelper::ConnectProbeToCollector(Ptr<Probe> probe, uint32_t identifier)
{
...
{
    static TypeId tid =
        TypeId("ns3::SatStatsFwdFeederLinkModcodHelper").SetParent<SatStatsLinkModcodHelper>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("ns3::SatStatsFwdUserLinkModcodHelper").SetParent<SatStatsLinkModcodHelper>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("ns3::SatStatsRtnFeederLinkModcodHelper").SetParent<SatStatsLinkModcodHelper>();
    return tid;
}
...
{
    static TypeId tid =
        TypeId("ns3::SatStatsRtnUserLinkModcodHelper").SetParent<SatStatsLinkModcodHelper>();
    return tid;
}
