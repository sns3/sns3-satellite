...
{
  static TypeId tid = TypeId ("ns3::SatStatsJitterHelper")
...
void
SatStatsJitterHelper::SaveAddressAndIdentifier (Ptr<Node> utNode)
{
...
bool
SatStatsJitterHelper::ConnectProbeToCollector (Ptr<Probe> probe,
                                              uint32_t identifier)
{
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdDevJitterHelper")
    .SetParent<SatStatsJitterHelper> ()
  ;
  return tid;
}
  ...
  for (NodeContainer::Iterator it = uts.Begin (); it != uts.End (); ++it)
    {
      ...
      // Connect the object to the probe.
      if (probe->ConnectByObject ("RxJitter", dev)
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdMacJitterHelper")
    .SetParent<SatStatsJitterHelper> ()
  ;
  return tid;
}
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdPhyJitterHelper")
    .SetParent<SatStatsJitterHelper> ()
  ;
  return tid;
}
...
{
  static TypeId tid = TypeId ("ns3::SatStatsRtnDevJitterHelper")
    .SetParent<SatStatsJitterHelper> ()
  ;
  return tid;
}
...
{
  static TypeId tid = TypeId ("ns3::SatStatsRtnMacJitterHelper")
    .SetParent<SatStatsJitterHelper> ()
  ;
  return tid;
}
...
{
  static TypeId tid = TypeId ("ns3::SatStatsRtnPhyJitterHelper")
    .SetParent<SatStatsJitterHelper> ()
  ;
  return tid;
}
