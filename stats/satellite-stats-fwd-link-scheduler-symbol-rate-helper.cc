...
SatStatsFwdLinkSchedulerSymbolRateHelper::SatStatsFwdLinkSchedulerSymbolRateHelper (Ptr<const SatHelper> satHelper)
  : SatStatsHelper (satHelper),
  m_traceSinkCallback (MakeCallback (&SatStatsFwdLinkSchedulerSymbolRateHelper::SymbolRateCallback, this))
{
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdLinkSchedulerSymbolRateHelper")
    ...
    case SatStatsHelper::OUTPUT_SCALAR_FILE:
      {
        ...
        m_aggregator = CreateAggregator ("ns3::MultiFileAggregator",
                                         ...
                                         "GeneralHeading", StringValue (GetIdentifierHeading ("symbol_rate_baud")));
    ...
    case SatStatsHelper::OUTPUT_SCATTER_FILE:
      {
        ...
        m_aggregator = CreateAggregator ("ns3::MultiFileAggregator",
                                         "OutputFileName", StringValue (GetOutputFileName ()),
                                         "GeneralHeading", StringValue (GetTimeHeading ("symbol_rate_baud")));
        Ptr<MultiFileAggregator> aggregator = m_aggregator->GetObject<MultiFileAggregator> ();
    ...
    case SatStatsHelper::OUTPUT_CDF_FILE:
      {
        ...
        m_aggregator = CreateAggregator ("ns3::MultiFileAggregator",
                                         "OutputFileName", StringValue (GetOutputFileName ()),
                                         "GeneralHeading", StringValue (GetDistributionHeading ("symbol_rate_baud")));
        Ptr<MultiFileAggregator> aggregator = m_aggregator->GetObject<MultiFileAggregator> ();
    ...
    case SatStatsHelper::OUTPUT_SCATTER_PLOT:
      {
        ...
        m_collectors.SetAttribute ("InputDataType",
                                   EnumValue (IntervalRateCollector::INPUT_DATA_TYPE_DOUBLE));
        CreateCollectorPerIdentifier (m_collectors);
        for (CollectorMap::Iterator it = m_collectors.Begin ();
