...
{
  static TypeId tid = TypeId ("ns3::SatStatsPacketDropRateHelper")
    ...
    case SatStatsHelper::OUTPUT_SCALAR_FILE:
      {
        ...
        m_aggregator = CreateAggregator ("ns3::MultiFileAggregator",
                                         ...
                                         "GeneralHeading", StringValue (GetIdentifierHeading ("packet_drop_rate")));
    ...
    case SatStatsHelper::OUTPUT_SCATTER_FILE:
      {
        ...
        m_aggregator = CreateAggregator ("ns3::MultiFileAggregator",
                                         "OutputFileName", StringValue (GetOutputFileName ()),
                                         "GeneralHeading", StringValue (GetTimeHeading ("packet_drop_rate")));
