  ...
  for (std::map<uint32_t, Ptr<SatPhy>>::iterator itPhy = satGeoFeederPhys.begin (); itPhy != satGeoFeederPhys.end (); ++itPhy)
    {
      ...
      ObjectVectorValue carriers;
      satPhyRx->GetAttribute ("RxCarrierList", carriers);
      NS_LOG_DEBUG (this << " Node ID " << satNode->GetId ()
...
SatStatsFwdFeederDaPacketErrorHelper::SatStatsFwdFeederDaPacketErrorHelper (Ptr<const SatHelper> satHelper)
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdFeederDaPacketErrorHelper")
...
SatStatsFwdUserDaPacketErrorHelper::SatStatsFwdUserDaPacketErrorHelper (Ptr<const SatHelper> satHelper)
  : SatStatsPacketErrorHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
  SetTraceSourceName ("DaRx");
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFwdUserDaPacketErrorHelper")
    .SetParent<SatStatsPacketErrorHelper> ()
  ;
  return tid;
}
...
SatStatsRtnFeederDaPacketErrorHelper::SatStatsRtnFeederDaPacketErrorHelper (Ptr<const SatHelper> satHelper)
  : SatStatsPacketErrorHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
  SetTraceSourceName ("DaRx");
...
{
  static TypeId tid = TypeId ("ns3::SatStatsRtnFeederDaPacketErrorHelper")
    .SetParent<SatStatsPacketErrorHelper> ()
  ;
  return tid;
}
...
SatStatsRtnUserDaPacketErrorHelper::SatStatsRtnUserDaPacketErrorHelper (Ptr<const SatHelper> satHelper)
  : SatStatsPacketErrorHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
  SetTraceSourceName ("DaRx");
...
{
  static TypeId tid = TypeId ("ns3::SatStatsRtnUserDaPacketErrorHelper")
    .SetParent<SatStatsPacketErrorHelper> ()
  ;
  return tid;
}
...
SatStatsFeederSlottedAlohaPacketErrorHelper::SatStatsFeederSlottedAlohaPacketErrorHelper (Ptr<const SatHelper> satHelper)
  : SatStatsPacketErrorHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
...
SatStatsUserSlottedAlohaPacketErrorHelper::SatStatsUserSlottedAlohaPacketErrorHelper (Ptr<const SatHelper> satHelper)
  : SatStatsPacketErrorHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
  SetTraceSourceName ("SlottedAlohaRxError");
...
SatStatsFeederCrdsaPacketErrorHelper::SatStatsFeederCrdsaPacketErrorHelper (Ptr<const SatHelper> satHelper)
  : SatStatsPacketErrorHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFeederCrdsaPacketErrorHelper")
    .SetParent<SatStatsPacketErrorHelper> ()
  ;
  return tid;
}
...
SatStatsUserCrdsaPacketErrorHelper::SatStatsUserCrdsaPacketErrorHelper (Ptr<const SatHelper> satHelper)
  : SatStatsPacketErrorHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
  SetTraceSourceName ("CrdsaUniquePayloadRx");
...
{
  static TypeId tid = TypeId ("ns3::SatStatsUserCrdsaPacketErrorHelper")
    .SetParent<SatStatsPacketErrorHelper> ()
  ;
  return tid;
}
...
SatStatsFeederEssaPacketErrorHelper::SatStatsFeederEssaPacketErrorHelper (Ptr<const SatHelper> satHelper)
  : SatStatsPacketErrorHelper (satHelper)
{
  NS_LOG_FUNCTION (this << satHelper);
...
{
  static TypeId tid = TypeId ("ns3::SatStatsFeederEssaPacketErrorHelper")
    .SetParent<SatStatsPacketErrorHelper> ()
  ;
  return tid;
}
...
{
  static TypeId tid = TypeId ("ns3::SatStatsUserEssaPacketErrorHelper")
    .SetParent<SatStatsPacketErrorHelper> ()
  ;
  return tid;
}
