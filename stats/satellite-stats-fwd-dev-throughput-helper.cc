...
#include "satellite-stats-fwd-dev-throughput-helper.h"
#include <ns3/log.h>
#include <ns3/enum.h>
...
NS_LOG_COMPONENT_DEFINE ("SatStatsFwdDevThroughputHelper");
...
void
SatStatsFwdDevThroughputHelper::DoInstall ()
{
  NS_LOG_FUNCTION (this);
...
void
SatStatsFwdDevThroughputHelper::InstallProbes (CollectorMap &collectorMap,
  ...
  for (NodeContainer::Iterator it = uts.Begin(); it != uts.End (); ++it)
    {
      ...
      probeName << utId;
      Ptr<PacketProbe> probe = CreateObject<PacketProbe> ();
