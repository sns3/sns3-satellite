 ...
 * Otherwise, the following example can be used:
 * \code
 * Ptr<SatStatsFwdFeederMacLinkJitterHelper> s = Create<SatStatsFwdFeederMacLinkJitterHelper> (satHelper);
 * s->SetName ("name");
 * s->SetIdentifierType (SatStatsHelper::IDENTIFIER_GLOBAL);
 * s->SetOutputType (SatStatsHelper::OUTPUT_SCATTER_FILE);
 * s->Install ();
 ...
 * Otherwise, the following example can be used:
 * \code
 * Ptr<SatStatsFwdUserMacLinkJitterHelper> s = Create<SatStatsFwdUserMacLinkJitterHelper> (satHelper);
 * s->SetName ("name");
 * s->SetIdentifierType (SatStatsHelper::IDENTIFIER_GLOBAL);
 * s->SetOutputType (SatStatsHelper::OUTPUT_SCATTER_FILE);
 * s->Install ();
 ...
 * Otherwise, the following example can be used:
 * \code
 * Ptr<SatStatsFwdFeederPhyLinkJitterHelper> s = Create<SatStatsFwdFeederPhyLinkJitterHelper> (satHelper);
 * s->SetName ("name");
 * s->SetIdentifierType (SatStatsHelper::IDENTIFIER_GLOBAL);
 * s->SetOutputType (SatStatsHelper::OUTPUT_SCATTER_FILE);
 * s->Install ();
 ...
 * Otherwise, the following example can be used:
 * \code
 * Ptr<SatStatsFwdUserPhyLinkJitterHelper> s = Create<SatStatsFwdUserPhyLinkJitterHelper> (satHelper);
 * s->SetName ("name");
 * s->SetIdentifierType (SatStatsHelper::IDENTIFIER_GLOBAL);
 * s->SetOutputType (SatStatsHelper::OUTPUT_SCATTER_FILE);
 * s->Install ();
 ...
 * Otherwise, the following example can be used:
 * \code
 * Ptr<SatStatsRtnFeederMacLinkJitterHelper> s = Create<SatStatsRtnFeederMacLinkJitterHelper> (satHelper);
 * s->SetName ("name");
 * s->SetIdentifierType (SatStatsHelper::IDENTIFIER_GLOBAL);
 * s->SetOutputType (SatStatsHelper::OUTPUT_SCATTER_FILE);
 * s->Install ();
 ...
 * Otherwise, the following example can be used:
 * \code
 * Ptr<SatStatsRtnUserMacLinkJitterHelper> s = Create<SatStatsRtnUserMacLinkJitterHelper> (satHelper);
 * s->SetName ("name");
 * s->SetIdentifierType (SatStatsHelper::IDENTIFIER_GLOBAL);
 * s->SetOutputType (SatStatsHelper::OUTPUT_SCATTER_FILE);
 * s->Install ();
 ...
 * Otherwise, the following example can be used:
 * \code
 * Ptr<SatStatsRtnFeederPhyLinkJitterHelper> s = Create<SatStatsRtnFeederPhyLinkJitterHelper> (satHelper);
 * s->SetName ("name");
 * s->SetIdentifierType (SatStatsHelper::IDENTIFIER_GLOBAL);
 * s->SetOutputType (SatStatsHelper::OUTPUT_SCATTER_FILE);
 * s->Install ();
 ...
 * Otherwise, the following example can be used:
 * \code
 * Ptr<SatStatsRtnUserPhyLinkJitterHelper> s = Create<SatStatsRtnUserPhyLinkJitterHelper> (satHelper);
 * s->SetName ("name");
 * s->SetIdentifierType (SatStatsHelper::IDENTIFIER_GLOBAL);
 * s->SetOutputType (SatStatsHelper::OUTPUT_SCATTER_FILE);
 * s->Install ();
