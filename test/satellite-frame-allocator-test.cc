 ...
 *  4. When desired UTs allocated, pre-allocate symbols for the UT/RC(s). (method
 * PreAllocateSymbols)
 ...
 *
 *  Expected result:
 *     Time slots for UT/RC should be generated according to allocation requests and limits in
 * frames.
 *
 *  NOTE:
