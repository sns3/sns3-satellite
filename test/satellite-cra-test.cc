 ...
 *  2.  A single packet is transmitted from Node-2 UDP application to Node-1 UDP receiver with only
 * CRA enabled.
 *
 *  Expected result:
...
SatCraTest1::SatCraTest1()
    : TestCase("'CRA, test 1' case tests successful transmission of UDP packets from UT connected "
               "user to GW connected user in simple scenario with only CRA enabled.")
{
}
