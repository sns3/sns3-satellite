 ...
 *   NULL is returned by Get method, if store time is expired or if same message is tried to read
 * twice.
 *
 *
 */
class SatCtrlMsgContDelOnTestCase : public SatCtrlMsgContBaseTestCase
{
  public:
    SatCtrlMsgContDelOnTestCase()
        : SatCtrlMsgContBaseTestCase(
              "Test satellite control message container with flag deletedOnRead set.")
    {
    }
...
SatCtrlMsgContDelOnTestCase::DoRun(void)
{
    ...
    Simulator::Schedule(Seconds(0.09),
                        &SatCtrlMsgContDelOnTestCase::AddMessage,
                        this,
                        crMsg); // id 0
    Simulator::Schedule(Seconds(0.20),
                        &SatCtrlMsgContDelOnTestCase::AddMessage,
                        this,
                        tbtpMsg); // id 1
    Simulator::Schedule(Seconds(0.31),
                        ...
                        this,
                        tbtpMsg); // id 2
    Simulator::Schedule(Seconds(0.40),
                        &SatCtrlMsgContDelOnTestCase::AddMessage,
                        this,
                        crMsg); // id 3

    // simulate get operations
    Simulator::Schedule(Seconds(0.10),
                        &SatCtrlMsgContDelOnTestCase::GetMessage,
                        this,
                        0); // crMsg expected
    Simulator::Schedule(Seconds(0.21),
                        &SatCtrlMsgContDelOnTestCase::GetMessage,
                        this,
                        1); // tbtpMsg expected
    Simulator::Schedule(Seconds(0.35),
                        ...
                        this,
                        2); // tbtpMsg expected
    Simulator::Schedule(Seconds(0.43),
                        &SatCtrlMsgContDelOnTestCase::GetMessage,
                        this,
                        3); // crMsg expected
...
class SatCtrlMsgContDelOffTestCase : public SatCtrlMsgContBaseTestCase
{
  public:
    SatCtrlMsgContDelOffTestCase()
        : SatCtrlMsgContBaseTestCase(
              "Test satellite control message container with flag deletedOnRead NOT set.")
    {
    }
