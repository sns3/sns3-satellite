...
SatConstantInterferenceTestCase::DoRun(void)
{
    ...
    Ptr<SatInterference::InterferenceChangeEvent> event =
        interference->Add(Time(10), 55, Mac48Address::ConvertFrom(Mac48Address::Allocate()));

    // Test event setting with constant interference (base class SatInterference can't be
    // instantiate)
    NS_TEST_ASSERT_MSG_EQ(event->GetDuration(), Time(10), "Event duration is incorrect");
    NS_TEST_ASSERT_MSG_EQ(event->GetEndTime() - event->GetStartTime(),
                          Time(10),
                          "Event start time or end time incorrect");
...
{
    Ptr<SatInterference::InterferenceChangeEvent> event =
        m_interference->Add(duration, power, rxAddress);
}
...
SatPerPacketInterferenceTestCase::StartReceiver(Time duration, double power, Address rxAddress)
{
    ...
    // schedule receiving
    Simulator::Schedule(Time(duration),
                        &SatPerPacketInterferenceTestCase::Receive,
                        this,
                        m_rxIndex);
...
SatPerPacketInterferenceTestCase::DoRun(void)
{
    ...
    Simulator::Schedule(Time(0),
                        &SatPerPacketInterferenceTestCase::AddInterference,
                        this,
                        Time(60),
                        60,
    ...
    Simulator::Schedule(Time(10),
                        ...
                        70,
                        Mac48Address::ConvertFrom(Mac48Address::Allocate()));
    Simulator::Schedule(Time(30),
                        &SatPerPacketInterferenceTestCase::AddInterference,
                        this,
                        Time(50),
                        10,
                        Mac48Address::ConvertFrom(Mac48Address::Allocate()));
    Simulator::Schedule(Time(50),
                        &SatPerPacketInterferenceTestCase::AddInterference,
                        this,
                        Time(40),
                        20,
                        Mac48Address::ConvertFrom(Mac48Address::Allocate()));
    Simulator::Schedule(Time(10),
                        &SatPerPacketInterferenceTestCase::StartReceiver,
                        this,
                        Time(90),
                        50,
                        Mac48Address::ConvertFrom(Mac48Address::Allocate())); // event[0]
    Simulator::Schedule(Time(20),
                        &SatPerPacketInterferenceTestCase::StartReceiver,
                        this,
                        Time(50),
                        5,
                        Mac48Address::ConvertFrom(Mac48Address::Allocate())); // event[1]
    Simulator::Schedule(Time(30),
                        &SatPerPacketInterferenceTestCase::StartReceiver,
                        this,
                        Time(60),
                        30,
                        Mac48Address::ConvertFrom(Mac48Address::Allocate())); // event[2]
    Simulator::Schedule(Time(50),
                        &SatPerPacketInterferenceTestCase::StartReceiver,
                        this,
                        Time(20),
                        40,
                        Mac48Address::ConvertFrom(Mac48Address::Allocate())); // event[3]
