 ...
 * Node-1 UDP receiver using periodic control message slots
...
SatPeriodicControlMessageTest1::SatPeriodicControlMessageTest1()
    : TestCase("'Periodic control message, test 1' case tests successful transmission of UDP "
               "packets from UT connected user to GW connected user in simple scenario with "
