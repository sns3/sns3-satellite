...
def build(bld):
    ...
    module.source = [
        ...
        'model/satellite-channel-external-fading-trace.cc',
        'model/satellite-channel-external-fading-trace-container.cc',
        ...
        'model/satellite-mac-id-mac-mapper.cc',
        'model/satellite-bbframe.cc',        
        'utils/satellite-env-variables.cc',
        'utils/satellite-base-singleton.cc',
    ...
    headers.source = [
        ...
        'model/satellite-channel-external-fading-trace.h',
        'model/satellite-channel-external-fading-trace-container.h',
        ...
        'utils/satellite-base-singleton.h',
