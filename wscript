...
def build(bld):
    ...
    module.source = [
        ...
        'model/satellite-fwd-link-scheduler-scpc.cc',
        ...
        'stats/satellite-stats-rtn-feeder-queue-helper.cc',
    ...
    headers.source = [
        ...
        'model/satellite-fwd-link-scheduler-scpc.h',
        ...
        'stats/satellite-stats-rtn-feeder-queue-helper.h',
