...
def build(bld):
    ...
    module.source = [
        ...
        'model/satellite-base-random-access.cc',
        'model/satellite-base-random-access-conf.cc',
        ...
        'model/satellite-slotted-aloha.cc',
        'model/satellite-slotted-aloha-conf.cc',
    ...
    headers.source = [
        ...
        'model/satellite-base-random-access.h',
        'model/satellite-base-random-access-conf.h',
        ...
        'model/satellite-slotted-aloha.h',
        'model/satellite-slotted-aloha-conf.h',
