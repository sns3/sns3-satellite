...
def build(bld):
    ...
    module.source = [
        ...
        'utils/satellite-output-stream-wrapper.cc',
        'utils/satellite-input-stream-wrapper.cc',
    ...
    headers.source = [
        ...
        'utils/satellite-output-stream-wrapper.h',
        'utils/satellite-input-stream-wrapper.h',
