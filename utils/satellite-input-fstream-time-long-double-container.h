 ...
 * \ingroup satellite
 *
 * \brief Class for input file stream container for long double values. Row format is [time, value1, ..., value n].
 */
...
private:
   ...
   * \return
   */
  bool FindNextClosest (uint32_t lastValidPosition, uint32_t column, long double shiftValue, long double comparisonValue);
...
#endif /* SAT_INPUT_FSTREAM_TIME_LONG_DOUBLE_CONTAINER_H */
